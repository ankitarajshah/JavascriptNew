...
const startLogoutTimer = function () {
  const tick = function () {
    ...
    if (time === 0) {
      clearInterval(timer);
      labelWelcome.textContent = `Login to get started back`;
...
//////////////////////// setTimeout
const ingre = ["olives", "op"];
const pizzaTime = setTimeout(
  (ing1, ing2) => console.log(`Hello Pizza with ${ing1} and ${ing2}`),
  3000,
  ...ingre
);
if (ingre.includes("spinach")) clearTimeout(pizzaTime);
